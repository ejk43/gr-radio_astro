...
class NsfPing(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        for c in range(0, 2):
            self.top_grid_layout.setColumnStretch(c, 1)
        self.radio_astro_ra_event_sink_0 = radio_astro.ra_event_sink('Event Detection', fftsize, Frequency*1.E-6, Bandwidth, EventMode, 'Event Detection', 'Science Aficionados', 'My Horn', '', Gain1, 0., 90.)
        ...
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate, analog.GR_SAW_WAVE, .0002, 1.00001, 0, 0)
        ...
        self._OffsetMHz_line_edit.returnPressed.connect(
            lambda: self.set_OffsetMHz(eng_notation.str_to_num(str(self._OffsetMHz_line_edit.text()))))
        ...
        self._FreqMHz_line_edit.returnPressed.connect(
            lambda: self.set_FreqMHz(eng_notation.str_to_num(str(self._FreqMHz_line_edit.text()))))
        ...
        self._Attn1_line_edit.returnPressed.connect(
            lambda: self.set_Attn1(eng_notation.str_to_num(str(self._Attn1_line_edit.text()))))
