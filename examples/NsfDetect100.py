...
class NsfDetect100(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        for c in range(6, 8):
            self.top_grid_layout.setColumnStretch(c, 1)
        self.radio_astro_ra_event_sink_0 = radio_astro.ra_event_sink('Event Detection', fftsize, Frequency*1.E-6, Bandwidth*1.E-6, EventMode, 'Event Detection', 'Science Aficionados', Telescope, Device, float(Gain1), Azimuth, Elevation)
